...
2. Duration of the short & long sections withon each CDT
...
the mean time necessary to reach 50% of the total reward in each session. 

![Half_reward](images/Half_reward.png)


## Duration of the short & long sections withon each CDT
...
by reducing the duration of this section.